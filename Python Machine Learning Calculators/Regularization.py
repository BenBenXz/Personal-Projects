...
# -*- coding: utf-8 -*-
"""
To Compute Mean Square Error (MSE)
Using Order Number, Lambda

Lookout for Training MSE and Test MSE: look for those with low values
look out for over and under fitting
